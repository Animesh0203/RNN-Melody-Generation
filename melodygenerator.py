...
class MelodyGenerator:
    ...
    def __init__(self, model_path="model_2.h5"):
    ...
    def generate_melody(self, seed, num_steps, max_sequence_length, temperature):
        """Generates a melody using the DL model and returns a list of symbols.
    ...
    def _sample_with_temperature(self, probabilities, temperature):
        ...
        # Maximum number of times a key can be repeated consecutively
        ...
        while True:
            ...
            # Check if the selected index is the same as the previous one
            if index == self.previous_index:
                consecutive_repeats += 1
            else:
                consecutive_repeats = 0

            # If the consecutive repeat limit is reached, force a change
            if consecutive_repeats >= max_consecutive_repeats:
                # Set the probability of the repeated index to 0
...
if __name__ == "__main__":
    mg = MelodyGenerator()
    seed = ""
    seed2 = "65 _ 75 _ 71 _ _ _ _ _ _ "
    melody = mg.generate_melody(seed, 500, 64, 0.7)
    print(melody)
